...
const LeadSuccessContainer: FC = () => {
  return (
    <div className="max-sm:bg-[#FBF9F0]">
      <Container>
        <section className="flex flex-col justify-between min-h-screen pb-14 gap-8 pt-40">
          <h1 className="w-full text-3xl font-semibold leading-relaxed mx-auto max-w-[400px] text-center">
            Thanks for your interest in{" "}
            <span className="font-bold text-[#2C00B9]">Keyvar Solutions!</span>
          </h1>
